...
| [Mini Explorer CLI](Projekty/Mini_Explorer_CLI/) | Eksplorator systemu plików w terminalu — flagi, walidacja, kody wyjścia | pathlib, argparse, pytest (tmp_path, monkeypatch, capsys) | 7/7 |
